 ...
 * Proxies to: genie/ep_send_message_dev (recipient_type is always "producer" here)
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await xanoFetch("genie/ep_send_message_dev", {
      method: "POST",
      authToken,
      body: { ...body, recipient_type: "producer" },
    });
