      ...
      <div className="relative z-10 mx-auto max-w-md">
        ...
        <div className="flex items-center justify-between border-b border-white/10 px-4 pb-4 pt-14">
          ...
          {hasUnread ? (
            <button
              ...
              className="text-[0.75rem] font-semibold text-red-400 hover:text-red-300"
            >
              Mark all ✓
            </button>
          ) : (
        ...
        {notifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center px-4 py-20 text-center">
            ...
            <p className="text-[0.9rem] text-white/40">No notifications yet</p>
          </div>
        ) : (
          <div className="divide-y divide-white/[0.08]">
            {notifications.map((notification) => (
              <button
                ...
                className={`flex w-full items-start gap-3 px-4 py-4 text-left transition hover:bg-white/5 ${
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 text-[0.78rem] leading-snug text-white/60">
                    {notification.body}
                  </p>
