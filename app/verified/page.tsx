...
function VerifiedContent() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[url('/bg-white.png')] bg-cover bg-center bg-no-repeat dark:bg-gradient-to-b dark:from-[#1a0505] dark:via-[#2a0a0a] dark:to-black px-6">
